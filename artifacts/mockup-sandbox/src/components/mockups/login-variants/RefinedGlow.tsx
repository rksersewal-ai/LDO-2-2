      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-white/8 rounded-2xl p-8 shadow-[0_0_80px_-10px_rgba(20,184,166,0.15),0_25px_50px_-12px_rgba(0,0,0,0.7)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold tracking-[0.12em] uppercase text-slate-500 mb-1.5">Username</label>
              <input 
                type="text" 
                value={username}
            ...
            <div>
              <label className="block text-[10px] font-bold tracking-[0.12em] uppercase text-slate-500 mb-1.5">Password</label>
          ...
          <div className="mt-6 pt-5 border-t border-white/5">
            <p className="text-[9px] font-bold tracking-[0.18em] uppercase text-slate-600 mb-3">Demo Credentials</p>
            <div className="space-y-1">
              {[
                ...
                >
                  ...
                  <span className="ml-auto text-slate-600 text-[10px] uppercase tracking-wider">{c.r}</span>
                </button>
              ))}
            </div>
          </div>
        ...
        <p className="mt-5 text-center text-[9px] text-slate-700 tracking-wider">v2.3.1 · LDO-2 Division · © 2026 RDSO</p>
      </div>
    </div>
  );
}
