...
- **Layout Requirements:**
  ...
  - **Left/Right Panels (Collapsible):**
    - _Metadata Panel:_ Author, dates, tags, revision history.
    - _OCR / Intelligence Panel:_ Extracted text, clickable matched references (hyperlinks to other docs).
    - _Relationships Panel:_ Linked PL numbers, "Used In" BOM references, linked Cases.
