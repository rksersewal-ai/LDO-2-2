...
function tagColor(tag: string) {
  ...
  if (t.includes("ndt"))
    return "bg-rose-900/40 text-rose-400 border-rose-500/20";
  if (t.includes("rdso"))
...
export default function PLDetail() {
  ...
  const legacyPL = !plRecord
    ? MOCK_PL_RECORDS.find((r) => r.id === id)
    : undefined;
    ...
    <div className="flex items-center justify-center h-[60vh]">
      <GlassCard className="p-12 text-center max-w-md">
        ...
        <p className="text-sm text-slate-400 mb-6">
          No PL record exists with identifier "{id}".
        </p>
...
function FullPLDetail({
  ...
  const bomNode = useMemo(
    () => findNode(INITIAL_BOM_TREE, pl.plNumber),
    [pl.plNumber],
  );
  ...
  const tabs = [
    ...
    {
      id: "bom",
      label: `BOM Structure${bomNode ? ` (${bomNode.children.length})` : ""}`,
    },
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Badge variant={statusBadgeVariant(pl.lifecycleState)}>
                {pl.lifecycleState}
              </Badge>
              {pl.safetyVital && (
            ...
            <div className="flex items-center gap-3 mt-1.5 pl-9 flex-wrap">
              <code className="text-sm text-teal-400 font-mono bg-teal-500/10 px-2.5 py-0.5 rounded-lg">
                PL {pl.plNumber}
              </code>
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <Button>
            <GitMerge className="w-4 h-4" /> Link Entity
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      },
                      {
                        ...
                        value: pl.lifecycleState,
                      },
                      { icon: MapPin, label: "Source", value: pl.source },
                      {
                        icon: Package,
                        label: "Unit of Measure",
                        value: pl.unitOfMeasure,
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
                      ...
                      >
                        ...
                        <span
                          className={`text-xs text-slate-200 ${(item as any).mono ? "font-mono text-teal-400" : ""}`}
                        >
                          {item.value}
                        </span>
                      </div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      },
                      {
                        ...
                        value: pl.classification,
                      },
                      {
                        icon: Shield,
                        label: "Safety Vital",
                        value: pl.safetyVital ? "Yes" : "No",
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      },
                      {
                        icon: Calendar,
                        label: "Created",
                        value: pl.createdDate,
                      },
                      {
                        icon: Clock,
                        label: "Last Modified",
                        value: pl.lastModified,
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
                  ...
                  {pl.supplier ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={pl.source === "Buy" ? "warning" : "success"}
                        >
                          {pl.source}
                        </Badge>
                      </div>
              ...
              <GlassCard className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {pl.tags.map((tag) => (
                    <span
                      key={tag}
                      className={`text-xs px-3 py-1 rounded-full border ${tagColor(tag)}`}
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <GlassCard className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {pl.alternates.length > 0 && (
                      <div>
                        <p className="text-xs text-slate-500 mb-2">
                          Alternate Parts (same form-fit-function)
                        </p>
                    ...
                    {pl.substitutes.length > 0 && (
                      <div>
                        <p className="text-xs text-slate-500 mb-2">
                          Substitute Parts (acceptable replacements)
                        </p>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-slate-800/50 text-slate-300">
                    {pl.linkedDocuments.map((doc) => (
                      ...
                      >
                        <td className="py-4 pl-6 font-mono text-teal-400 text-xs">
                          {doc.docId}
                        </td>
                  ...
                  <tbody className="divide-y divide-slate-800/50 text-slate-300">
                    {pl.linkedDrawings.map((dwg) => (
                      <tr
                        ...
                        className="hover:bg-slate-800/30 cursor-pointer transition-colors"
                      >
                        <td className="py-4 pl-6 font-mono text-indigo-400 text-xs">
                          {dwg.drawingId}
                        </td>
                        <td className="py-4 text-xs">
                          <div className="flex items-center gap-2">
                        ...
                        <td className="py-4">
                          <Badge
                            variant={statusBadgeVariant(dwg.status)}
                            className="text-[10px]"
                          >
                            {dwg.status}
                          </Badge>
            ...
            <GlassCard className="p-6">
              {bomNode && bomNode.children.length > 0 ? (
                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-slate-800/40 text-slate-300">
                      {bomNode.children.map((child) => (
                        <tr
                          key={child.id}
                          onClick={() => navigate(`/pl/${child.id}`)}
                          className="hover:bg-slate-800/30 cursor-pointer transition-colors"
                        >
                          <td className="py-3 text-xs text-slate-500">
                            {child.findNumber}
                          </td>
                          <td className="py-3 font-mono text-teal-400 text-xs">
                            {child.id}
                          </td>
                          ...
                          <td className="py-3 text-xs text-teal-400">
                            {child.quantity}
                          </td>
                          <td className="py-3 text-xs text-slate-500">
                            {child.unitOfMeasure}
                ...
                <div className="text-center py-8 text-slate-500">
                  ...
                  <p className="text-sm">
                    {bomNode
                      ? "This is a leaf part with no children."
                      : "BOM structure data not available."}
                  </p>
                  <Button
                    variant="secondary"
                    className="mt-4"
            ...
            <GlassCard className="p-6">
              {pl.whereUsed.length > 0 ? (
                <>
                  ...
                  <div className="space-y-3">
                    {pl.whereUsed.map((wu, i) => (
                      <div
                        key={i}
                        onClick={() => navigate(`/pl/${wu.parentPL}`)}
                ...
                <div className="text-center py-8 text-slate-500">
                  ...
                  <p className="text-sm">
                    This is a top-level assembly — not used in other structures.
                  </p>
                </div>
              )}
            </GlassCard>
            ...
            <GlassCard className="p-6">
              {pl.changeHistory.length > 0 ? (
                <>
                  ...
                  <div className="space-y-3">
                    {pl.changeHistory.map((ch) => (
                      <div
                        key={ch.changeId}
                        className="p-4 rounded-xl border border-slate-700/40 bg-slate-800/20"
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <Badge variant={statusBadgeVariant(ch.status)}>
                            {ch.status}
                          </Badge>
                        </div>
                ...
                <div className="text-center py-8 text-slate-500">
                  ...
                  <p className="text-sm">
                    No engineering changes recorded for this part.
                  </p>
                </div>
              )}
            </GlassCard>
            ...
            <GlassCard className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5">
                  <h4
                    className="text-xs text-amber-400 mb-3 uppercase tracking-wider"
                    style={{ fontWeight: 600 }}
                  >
                    Date Effectivity
                  </h4>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs text-slate-200">
                        {pl.effectivity.dateTo || "Open (Current)"}
                      </span>
                    </div>
                  </div>
                </div>
                <div className="p-4 rounded-xl border border-blue-500/20 bg-blue-500/5">
                  <h4
                    className="text-xs text-blue-400 mb-3 uppercase tracking-wider"
                    style={{ fontWeight: 600 }}
                  >
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <code className="text-xs text-slate-200 font-mono">
                        {pl.effectivity.serialFrom || "—"}
                      </code>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-xs text-slate-500">Serial To</span>
                      <code className="text-xs text-slate-200 font-mono">
                        {pl.effectivity.serialTo || "Open"}
                      </code>
                    </div>
                  </div>
                </div>
              </div>
              {pl.effectivity.lotNumbers &&
                pl.effectivity.lotNumbers.length > 0 && (
                  <div className="mt-4 p-4 rounded-xl border border-purple-500/20 bg-purple-500/5">
                    <h4
                      className="text-xs text-purple-400 mb-3 uppercase tracking-wider"
                      style={{ fontWeight: 600 }}
                    >
                      Lot Effectivity
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {pl.effectivity.lotNumbers.map((lot) => (
                        <code
                          key={lot}
                          className="text-xs bg-purple-900/30 text-purple-300 px-3 py-1 rounded-lg border border-purple-500/20 font-mono"
                        >
                          {lot}
                        </code>
                      ))}
        ...
        <div className="space-y-6">
          ...
          <GlassCard className="p-5 bg-gradient-to-b from-slate-900/60 to-teal-950/20">
            <h3
              className="text-xs text-slate-500 uppercase tracking-widest mb-3 flex items-center gap-2"
              style={{ fontWeight: 700 }}
            >
              <Box className="w-4 h-4 text-teal-400" /> BOM Navigation
            </h3>
            <p className="text-xs text-slate-400 mb-3">
              View this part in the interactive BOM structure editor.
            </p>
            <Button
              variant="secondary"
              className="w-full"
          ...
          {pl.safetyVital && (
            <GlassCard className="p-5 border-rose-500/20">
              <h3
                className="text-xs text-rose-400 uppercase tracking-widest mb-3 flex items-center gap-2"
                style={{ fontWeight: 700 }}
              >
                <Shield className="w-4 h-4" /> Safety Classification
              </h3>
              <p className="text-xs text-slate-400 mb-3">
                This item is classified as Safety Vital. All modifications
                require enhanced review and approval.
              </p>
              <div className="p-3 rounded-lg bg-rose-500/10 border border-rose-500/20">
                <p className="text-[10px] text-rose-300">
                  Engineering Change Orders (ECO) are mandatory for any
                  modification to this part.
                </p>
              </div>
            </GlassCard>
          )}
              ...
              {(() => {
                ...
                return (
                  <div className="p-3 bg-slate-800/30 border border-slate-700/30 rounded-lg">
                    <code className="text-[10px] text-amber-400 font-mono">
                      {latest.changeId}
                    </code>
...
function LegacyPLDetail({
  ...
  const linkedDocsDetails = MOCK_DOCUMENTS.filter((d: any) =>
    pl.linkedDocs.includes(d.id),
  );
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1 font-mono pl-9">
              {pl.id} • Last Updated: {pl.lastUpdated}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Button>
            <GitMerge className="w-4 h-4" /> Link New Entity
          </Button>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6 border-b border-slate-700/50 mb-6">
        {[
          ...
          {
            id: "documents",
            label: `Linked Documents (${pl.linkedDocs.length})`,
          },
            ...
            <GlassCard className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <div className="text-sm text-slate-200">{pl.lifecycle}</div>
                </div>
                <div>
                  <label className="text-xs text-slate-500 block mb-1">
                    Owner
                  </label>
                  <div className="text-sm text-slate-200">{pl.owner}</div>
                </div>
                <div>
                  <label className="text-xs text-slate-500 block mb-1">
                    Classification
                  </label>
                  <div className="text-xs text-slate-200 border border-slate-700 px-2 py-0.5 rounded inline-block">
                    Internal Restrict
                  </div>
                </div>
              </div>
              ...
              <table className="w-full text-left text-sm whitespace-nowrap">
                <thead>
                  <tr className="border-b border-slate-700/50 text-slate-400 bg-slate-900/50">
                    <th className="py-3 pl-6" style={{ fontWeight: 600 }}>
                      Document ID
                    </th>
                ...
                <tbody className="divide-y divide-slate-800/50 text-slate-300">
                  {linkedDocsDetails.map((doc: any) => (
                    ...
                    >
                      <td className="py-4 pl-6 font-mono text-teal-400 hover:underline">
                        {doc.id}
                      </td>
                      ...
                      <td className="py-4">
                        <Badge
                          variant={
                            doc.status === "Approved" ? "success" : "default"
                          }
                          className="text-[10px]"
                        >
                          {doc.status}
          ...
          {activeTab === "bom" && (
            <GlassCard className="p-12 flex flex-col items-center justify-center text-slate-500 text-center">
              ...
              <p className="max-w-md">
                View this record's BOM context in the interactive explorer.
              </p>
              <Button
                variant="secondary"
                className="mt-6"
            ...
            {pl.cases.length > 0 ? (
              <div className="space-y-3">
                {pl.cases.map((caseId: string) => (
                  <div
                    key={caseId}
                    className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg hover:bg-amber-500/20 cursor-pointer transition-colors flex items-start gap-3"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-amber-300/80 mt-1">
                        Pending review on linked drawing discrepancies.
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="text-sm text-slate-500 flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-teal-500" /> No active
                cases.
              </div>
            )}
          </GlassCard>
