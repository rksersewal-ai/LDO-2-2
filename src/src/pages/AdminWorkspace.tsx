    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <GlassCard className="p-4 flex items-center gap-4">
          ...
          <div>
            <div className="text-sm text-slate-400" style={{ fontWeight: 500 }}>
              OCR Engine Status
            </div>
            <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {quickLinks.map((link) => (
          ...
          >
            <div
              className={`w-10 h-10 rounded-lg ${link.color} flex items-center justify-center mb-3`}
            >
              <link.icon className="w-5 h-5" />
            </div>
            <h3
              className="text-sm text-slate-200 mb-1 group-hover:text-teal-300 transition-colors"
      ...
      <GlassCard className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            View Full Audit Log <ArrowRight className="w-3 h-3 ml-1" />
          </Button>
        </div>
        <div className="space-y-2">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-rose-500/5 border border-rose-500/20">
            ...
            <span className="text-sm text-rose-300">
              OCR extraction failed for DOC-2026-9023 — resolution below
              threshold
            </span>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-amber-500/5 border border-amber-500/20">
            ...
            <span className="text-sm text-amber-300">
              Permission denied: s.vance attempted to access Admin Settings
            </span>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-rose-500/5 border border-rose-500/20">
            <AlertTriangle className="w-4 h-4 text-rose-400" />
            <span className="text-sm text-rose-300">
              Failed login attempt from 10.0.9.88
            </span>
