...
export default function WorkLedger() {
  ...
  const [selectedWork, setSelectedWork] = useState<
    (typeof MOCK_WORK_LEDGER)[0] | null
  >(null);

  const filtered = MOCK_WORK_LEDGER.filter(
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Track, create, and manage work records across the organization.
          </p>
        </div>
      ...
      <GlassCard className="p-4">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          <div className="flex gap-2 ml-auto">
            {["Complete", "In Progress", "Pending", "Pending Verification"].map(
              (s) => (
                <button
                  key={s}
        ...
        {filtered.length === 0 && (
          <div className="py-16 text-center text-slate-500">
            No work records match the current filter.
          </div>
        )}
      </GlassCard>
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="mt-0.5">
                    <Badge variant={statusVariant(selectedWork.status)}>
                      {selectedWork.status}
                    </Badge>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-0.5">
                    <Badge
                      variant={
                        selectedWork.priority === "High" ? "danger" : "default"
                      }
                    >
              ...
              <div className="border-t border-slate-700/50 pt-4">
                ...
                <div
                  ...
                  onClick={() => navigate(`/pl/${selectedWork.linkedPL}`)}
                >
                  {selectedWork.linkedPL}
                </div>
              </div>
              <div>
                ...
                <div
                  className="text-sm text-teal-400 cursor-pointer hover:underline mt-0.5"
                  onClick={() =>
                    navigate(`/documents/${selectedWork.linkedDoc}`)
                  }
                >
              ...
              <div className="flex gap-3 pt-4">
                ...
                {selectedWork.status === "Pending Verification" && (
                  <Button className="flex-1">Verify & Close</Button>
                )}
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input className="w-full" placeholder="Work record title" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-slate-300 mb-1">
              ...
              <div>
                ...
                <Input className="w-full" placeholder="e.g. PL-55092" />
              </div>
              <div>
                <label className="block text-sm text-slate-300 mb-1">
                  Linked Document
                </label>
                <Input className="w-full" placeholder="e.g. DOC-2026-9021" />
              </div>
