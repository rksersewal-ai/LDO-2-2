      ...
      <div className="w-full max-w-md relative z-10">
              ...
              <div>
                ...
                {loginAttempts >= 3 && (
                  <p className="text-xs text-rose-400/70 mt-1">
                    Multiple failed attempts detected. Contact IT if you need
                    assistance.
                  </p>
                )}
              </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  clearError();
                  setValidation((v) => ({ ...v, username: undefined }));
                }}
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    clearError();
                    setValidation((v) => ({ ...v, password: undefined }));
                  }}
        ...
        <div className="mt-6 text-center">
          ...
          <p className="text-slate-700 text-[10px] mt-2">
            LDO-2 EDMS v3.8.1 • Internal Systems Division
          </p>
        </div>

        {/* Demo credentials hint */}
        <div className="mt-6 p-3 rounded-xl bg-slate-900/40 border border-slate-700/30 text-xs text-slate-500">
          <p style={{ fontWeight: 600 }} className="text-slate-400 mb-1">
            Demo Credentials:
          </p>
          <p>
            <span className="text-teal-400/80">a.kowalski</span> / ldo2pass
            (Engineer)
          </p>
          <p>
            <span className="text-teal-400/80">admin</span> / admin123
            (Administrator)
          </p>
          <p>
            <span className="text-teal-400/80">m.chen</span> / ldo2pass
            (Reviewer)
          </p>
        </div>
      </div>
